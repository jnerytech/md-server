...
A sidebar SHALL listar todos os arquivos `.md` encontrados na raiz servida, agrupados por diretório, em todas as páginas de conteúdo.
...
- **WHEN** existem arquivos `.md` diretamente na raiz (sem subpasta)
